            ...
            <div className="flex flex-row justify-center items-center">
                <div className="w-140 mr-20">
                    <p className="text-slate-950 dark:text-slate-50
                                  poppins-regular text-base text-justify mt-2 mb-5"><strong className="poppins-semi-bold text-blue-500">Hello, World! I'm Jun Nathan</strong>, a highly committed computer science fresh graduate who is eager to <strong className="poppins-semi-bold text-blue-500">excellently elevate experiences</strong> in the progressive field of technology.</p>
                    <p className="text-slate-950 dark:text-slate-50 
                                  poppins-regular text-base text-justify mb-5">My academic pursuits have equipped me with foundational knowledge in <strong className="poppins-semi-bold text-blue-500">Python and Java programming, web development, database management, and natural language processing</strong> while improving my skills in <strong className="poppins-semi-bold text-blue-500">documentation and designing diagrams</strong>.</p>
                    <p className="text-slate-950dark:text-slate-50 
                                  poppins-regular text-base text-justify">Moreover, my journey as a backend developer intern gave me the opportunity to gain hands-on experience and further learn about <strong className="poppins-semi-bold text-blue-500">APIs, low code development, and Git version control</strong>. As a budding tech professional, I am ready to leverage my capabilities to develop solutions as I put my work principles in practice.</p>
                </div>
